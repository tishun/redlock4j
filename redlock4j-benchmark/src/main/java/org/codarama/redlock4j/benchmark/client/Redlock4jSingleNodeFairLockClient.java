...
/**
 * Fair lock client using redlock4j with single node.
 * This provides a fair comparison with Redisson's single-node RFairLock.
 */
public class Redlock4jSingleNodeFairLockClient extends AbstractFairLockClient {
    ...
    public void initialize(BenchmarkConfiguration config, RedisClusterManager clusterManager) {
        // Use only the first node, like Redisson does
