...
/**
 * Abstract base class for distributed lock benchmark clients.
 */
public abstract class AbstractDistributedLockClient implements DistributedLockBenchmarkClient {
    ...
    public BenchmarkResult runBenchmark(String clientId, BenchmarkConfiguration config, RedisResultsStore resultsStore) {
        ...
        Lock lock = getLock(config.getLockResourceName());
        ...
        logger.info("Client {} ({}) starting distributed lock benchmark", clientId, getImplementationType());
